...
stargazer(sample_selection_2s_with, sample_selection_2s_without,
          ...
          column.labels = c("Two-step with exclusion", "Two-step without exclusion"),
          title = 'Log earnings regression with two-step approach, 
...
stargazer(sample_selection_ml_with, sample_selection_ml_without,
          style = "AER",
          font.size = "small",
          header = F, label = 'tab:q1_e',
          column.labels = c("ML with exclusion", "ML without exclusion"),
          title = 'Log earnings regression with maximum likelihood, 
          with and without the exclusion variable.')
```

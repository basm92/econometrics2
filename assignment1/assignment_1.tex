...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{model\_}\DecValTok{1}\NormalTok{ \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ data, }\DataTypeTok{formula =}\NormalTok{ logWage }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2)}

\NormalTok{results\_}\DecValTok{1}\NormalTok{ \textless{}{-}}\StringTok{ }\KeywordTok{summary.lm}\NormalTok{(model\_}\DecValTok{1}\NormalTok{)}
\NormalTok{coeffs\_}\DecValTok{1}\NormalTok{ \textless{}{-}}\StringTok{ }\NormalTok{results\_}\DecValTok{1}\OperatorTok{$}\NormalTok{coefficients[,}\DecValTok{1}\NormalTok{]}
\NormalTok{pvals\_}\DecValTok{1}\NormalTok{ \textless{}{-}}\StringTok{ }\NormalTok{results\_}\DecValTok{1}\OperatorTok{$}\NormalTok{coefficients[,}\DecValTok{4}\NormalTok{]}

\KeywordTok{stargazer}\NormalTok{(model\_}\DecValTok{1}\NormalTok{, }\DataTypeTok{style =} \StringTok{"AER"}\NormalTok{,}
          \DataTypeTok{font.size =} \StringTok{"small"}\NormalTok{,}
          \DataTypeTok{header =}\NormalTok{ F, }\DataTypeTok{label =} \StringTok{\textquotesingle{}tab:q1\_a\_ols\textquotesingle{}}\NormalTok{,}
          \DataTypeTok{title =} \StringTok{\textquotesingle{}OLS regression for log{-}earnings on schooling, age and age squared.\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Construct I (I=1 for y\_i\^{}* != na, else 0)}
\NormalTok{data}\OperatorTok{$}\NormalTok{I \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(data}\OperatorTok{$}\NormalTok{logWage) , }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{) }\CommentTok{\# if na, then I is zero. Else 1.}

\NormalTok{sample\_selection\_2s\_with \textless{}{-}}\StringTok{ }\KeywordTok{selection}\NormalTok{(I }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2 }\OperatorTok{+}\StringTok{ }\NormalTok{married, }
\NormalTok{                                logWage }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2, }\DataTypeTok{data=}\NormalTok{data, }
                                \DataTypeTok{method=}\StringTok{\textquotesingle{}2step\textquotesingle{}}\NormalTok{)}
\NormalTok{coeffs\_sample\_selection\_2s\_with \textless{}{-}}\StringTok{ }\NormalTok{sample\_selection\_2s\_with}\OperatorTok{$}\NormalTok{coefficients}


\CommentTok{\#\# using package \textquotesingle{}sampleSelection\textquotesingle{} to get maximum likelihood estimates:}
\NormalTok{sample\_selection\_2s\_without \textless{}{-}}\StringTok{ }\KeywordTok{selection}\NormalTok{(I }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2, }
\NormalTok{                                logWage }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2, }\DataTypeTok{data=}\NormalTok{data, }
                                \DataTypeTok{method=}\StringTok{\textquotesingle{}2step\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coeffs\_sample\_selection\_2s\_without \textless{}{-}}\StringTok{ }\NormalTok{sample\_selection\_2s\_without}\OperatorTok{$}\NormalTok{coefficients}


\CommentTok{\# Obtain output:}
\KeywordTok{stargazer}\NormalTok{(sample\_selection\_2s\_with, sample\_selection\_2s\_without,}
          \DataTypeTok{style =} \StringTok{"AER"}\NormalTok{,}
          \DataTypeTok{font.size =} \StringTok{"small"}\NormalTok{,}
          \DataTypeTok{header =}\NormalTok{ F, }\DataTypeTok{label =} \StringTok{\textquotesingle{}tab:q1\_d\textquotesingle{}}\NormalTok{,}
          ...
          \DataTypeTok{title =} \StringTok{\textquotesingle{}Log earnings sample selection regression with two{-}step approach, }
\StringTok{          with and without the exclusion variable.\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{\# Construct I (I=1 for y\_i\^{}* != na, else 0)}
\NormalTok{sample\_selection\_ml\_with \textless{}{-}}\StringTok{ }\KeywordTok{selection}\NormalTok{(I }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2 }\OperatorTok{+}\StringTok{ }\NormalTok{married, }
\NormalTok{                                logWage }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2, }\DataTypeTok{data=}\NormalTok{data, }
                                \DataTypeTok{method=}\StringTok{\textquotesingle{}ml\textquotesingle{}}\NormalTok{)}
\NormalTok{coeffs\_sample\_selection\_ml\_with \textless{}{-}}\StringTok{ }\NormalTok{sample\_selection\_ml\_with}\OperatorTok{$}\NormalTok{estimate[}\DecValTok{6}\OperatorTok{:}\DecValTok{9}\NormalTok{]}


\CommentTok{\#\# using package \textquotesingle{}sampleSelection\textquotesingle{} to get maximum likelihood estimates:}
\NormalTok{sample\_selection\_ml\_without \textless{}{-}}\StringTok{ }\KeywordTok{selection}\NormalTok{(I }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2, }
\NormalTok{                                logWage }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2, }\DataTypeTok{data=}\NormalTok{data, }
                                \DataTypeTok{method=}\StringTok{\textquotesingle{}ml\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{coeffs\_sample\_selection\_ml\_without \textless{}{-}}\StringTok{ }\NormalTok{sample\_selection\_ml\_without}\OperatorTok{$}\NormalTok{coefficients}

\CommentTok{\# Obtain output:}
\KeywordTok{stargazer}\NormalTok{(sample\_selection\_ml\_with, sample\_selection\_ml\_without,}
          \DataTypeTok{style =} \StringTok{"AER"}\NormalTok{,}
          \DataTypeTok{font.size =} \StringTok{"small"}\NormalTok{,}
          \DataTypeTok{header =}\NormalTok{ F, }\DataTypeTok{label =} \StringTok{\textquotesingle{}tab:q1\_e\textquotesingle{}}\NormalTok{, }\DataTypeTok{digits=}\DecValTok{3}\NormalTok{,}
          ...
          \DataTypeTok{title =} \StringTok{\textquotesingle{}Log earnings sample selection regression with maximum likelihood, }
\StringTok{          with and without the exclusion variable.\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{data}\OperatorTok{$}\NormalTok{est\_log\_wage\textless{}{-}}\OtherTok{NaN}
...
\NormalTok{  data}\OperatorTok{$}\NormalTok{est\_log\_wage[i] \textless{}{-}}\StringTok{ }\NormalTok{coeffs\_sample\_selection\_ml\_with }\OperatorTok{\%*\%}\StringTok{ }\KeywordTok{cbind}\NormalTok{(}\DecValTok{1}\NormalTok{, }
...
\NormalTok{data}\OperatorTok{$}\NormalTok{d\_unem \textless{}{-}}\StringTok{ }\KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(data}\OperatorTok{$}\NormalTok{logWage) , }\DecValTok{1}\NormalTok{, }\OtherTok{NaN}\NormalTok{) }\CommentTok{\# if na, then d\_unem is 1. Else NaN.}

\CommentTok{\# Construct vector of unemployed log(Wage) predictions:}
\NormalTok{log\_wage\_unemployed \textless{}{-}}\StringTok{ }\KeywordTok{na.omit}\NormalTok{(data}\OperatorTok{$}\NormalTok{d\_unem }\OperatorTok{*}\StringTok{ }\NormalTok{data}\OperatorTok{$}\NormalTok{est\_log\_wage)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hoi \textless{}{-}}\StringTok{ }\KeywordTok{summary}\NormalTok{(}

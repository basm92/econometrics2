...
\CommentTok{\#\# Two stage approach:}
\CommentTok{\# Stage 1:}
\NormalTok{probit \textless{}{-}}\StringTok{ }\KeywordTok{glm}\NormalTok{(I }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{married, }
...
\NormalTok{Z\_gamma \textless{}{-}}\StringTok{ }\KeywordTok{cbind}\NormalTok{(}\DecValTok{1}\NormalTok{,data}\OperatorTok{$}\NormalTok{married) }\OperatorTok{\%*\%}\StringTok{ }\KeywordTok{coef}\NormalTok{(probit) }
\NormalTok{inverse\_mills\_ratio \textless{}{-}}\StringTok{ }\KeywordTok{dnorm}\NormalTok{(Z\_gamma, }\DataTypeTok{mean=}\DecValTok{0}\NormalTok{, }\DataTypeTok{sd=}\DecValTok{1}\NormalTok{) }\OperatorTok{/}\StringTok{ }\KeywordTok{pnorm}\NormalTok{(Z\_gamma, }\DataTypeTok{mean=}\DecValTok{0}\NormalTok{, }\DataTypeTok{sd=}\DecValTok{1}\NormalTok{)}

\CommentTok{\# Stage 2:}
\NormalTok{sample\_selection\_2sls \textless{}{-}}\StringTok{ }\KeywordTok{lm}\NormalTok{(logWage }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2 }\OperatorTok{+}\StringTok{ }\NormalTok{inverse\_mills\_ratio,}
                                   \DataTypeTok{data=}\NormalTok{data)}

<<<<<<< HEAD
\CommentTok{## using package 'sampleSelection' to get maximum likelihood estimates:}
\NormalTok{sample_selection_ml <-}\StringTok{ }\KeywordTok{selection}\NormalTok{(I }\OperatorTok{~}\StringTok{ }\NormalTok{married, }
...
\NormalTok{sample\_selection\_ml \textless{}{-}}\StringTok{ }\KeywordTok{heckit}\NormalTok{(I }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{married, }
\NormalTok{                                logWage }\OperatorTok{\textasciitilde{}}\StringTok{ }\NormalTok{schooling }\OperatorTok{+}\StringTok{ }\NormalTok{age }\OperatorTok{+}\StringTok{ }\NormalTok{age2, }\DataTypeTok{data=}\NormalTok{data, }\DataTypeTok{method=}\StringTok{\textquotesingle{}ml\textquotesingle{}}\NormalTok{)}
>>>>>>> attempt_walter

\CommentTok{\# Obtain output:}
\KeywordTok{stargazer}\NormalTok{(sample\_selection\_2sls, }
          \DataTypeTok{se =} \KeywordTok{starprep}\NormalTok{(sample\_selection\_2sls, }\DataTypeTok{se\_type =} \StringTok{"HC1"}\NormalTok{),}
          \DataTypeTok{style =} \StringTok{"AER"}\NormalTok{,}
          \DataTypeTok{font.size =} \StringTok{"small"}\NormalTok{,}
<<<<<<< HEAD
          \DataTypeTok{header =}\NormalTok{ F, }\DataTypeTok{label =} \StringTok{'tab:q1_d_2sls'}\NormalTok{,}
          \DataTypeTok{title =} \StringTok{'Sample selection regression for log-earnings on schooling, age}
\StringTok{          and age squared, using two stage approach'}\NormalTok{)}
=======
          \DataTypeTok{header =}\NormalTok{ F, }\DataTypeTok{label =} \StringTok{\textquotesingle{}tab:q1\_d\_2sls\textquotesingle{}}\NormalTok{,}
          \DataTypeTok{title =} \StringTok{\textquotesingle{}Sample selection regression for log{-}earnings on schooling, age}
\StringTok{          and age squared, using two stage approach\textquotesingle{}}\NormalTok{)}
>>>>>>> attempt_walter
\end{Highlighting}
\end{Shaded}

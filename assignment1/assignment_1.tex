...
\KeywordTok{plot}\NormalTok{(}\KeywordTok{density}\NormalTok{(log_wage_unemployed), }\DataTypeTok{main=}\StringTok{'log(Wage) distribution of the unemployed'}\NormalTok{,}
